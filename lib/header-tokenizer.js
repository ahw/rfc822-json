...
function HeaderTokenizer() {
    ...
    this.currentToken = new HeaderToken({type: 'field_name', value: ""});
}
...
HeaderTokenizer.prototype.states = {
    ...
    // transitions to this trap state.
    DONE: 'DONE'
};

// Implements the Stream.Writable._write method.
HeaderTokenizer.prototype._write = function(chunk, encoding, callback) {
...
// header field bodies. The "token" events have the corresponding
// HeaderToken as the argument for their listener functions.
